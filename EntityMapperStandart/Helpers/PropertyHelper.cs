...
namespace EntityMapperStandart.Helpes
{
    public class PropertyHelper
    {
        ...
        public PropertyHelper(PropertyInfo property)
        {
            ...
            Name = property.Name;
            CRMFieldBaseAttribute = GetCrmFieldAttribute(property);

        }
        public CRMFieldBaseAttribute CRMFieldBaseAttribute { get; set; }
        ...
        private static CRMFieldBaseAttribute GetCrmFieldAttribute(PropertyInfo propertyInfo)
        {
            return propertyInfo.GetCustomAttributes(typeof(CRMFieldBaseAttribute), true).Cast<CRMFieldBaseAttribute>().FirstOrDefault();
        }
